...
syn keyword zimbuCompType	string stringpart stringval
syn keyword zimbuCompType	bytes bytespart bytesval
syn keyword zimbuCompType	tuple list dict multiDict set multiSet
syn keyword zimbuCompType	complex complex32 complex64 complex80 complex128
syn keyword zimbuCompType	proc func thread

syn keyword zimbuType   VAR ANY Time
...
syn keyword zimbuStatement DO UNTIL SWITCH
...
syn keyword zimbuModule  CHECK IO SYS ARG HTTP ZWT PROTO
...
syn region zimbuC matchgroup=zimbuCblock start="^>>>.*" end="^<<<.*" contains=@Ccode keepend
