...
" TeX Compiler setting
if has('win32') || has('win64')
  if &fileencoding ==# 'utf-8'
    let b:tex_flavor = 'platex -kanji=utf8 '
  elseif &fileencoding =~# '^euc-\%(jp\|jisx0213\)$'
    let b:tex_flavor = 'platex -kanji=euc '
  elseif &fileencoding =~# '^iso-2022-jp'
    let b:tex_flavor = 'platex -kanji=jis '
  else " cp932
    let b:tex_flavor = 'platex -kanji=sjis '
  endif
else
  let b:tex_flavor = 'platex '
endif
"let b:tex_flavor .= expand("%")
